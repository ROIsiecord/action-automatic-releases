        ...
        try {
            const e = (() => {
                    const e = {
                            ...
                            files: [],
                            generateReleaseNotes: JSON.parse(u.getInput("generate_release_notes", {
                                required: !0
                            }))
                        },
                        t = u.getInput("files", {
            ...
            u.startGroup("Initializing the Automatic Releases action"), l.dumpGitHubEventPayload(), u.debug(`Github context: ${JSON.stringify(r)}`), u.endGroup(), u.endGroup();
            ...
            const f = yield((e, t) => s(void 0, void 0, void 0, (function* () {
                ...
                body: d,
                generate_release_notes: i.generateReleaseNotes
            });
